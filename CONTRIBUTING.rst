...
Thank you for your help improving **eebit**!

**eebit** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **eebit** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/eebit
   cd eebit
...
This will install the **eebit** library, together with two additional tools:
